...
curl -H"Content-type: application/json" -d'{"_id":"id_widget", "name":"widget", "fields":["make", "model"]}' $base/template

curl -H"Content-type: application/json" -d'{"_id":"id_storage", "name":"storage", "fields":["capacity"], "parent_id":"id_widget"}' $base/template
...
curl -H"Content-type: application/json" -d'{"_id":"id_inputdevice", "name":"input device", "fields":["port"], "parent_id":"id_widget"}' $base/template
...
curl -H"Content-type: application/json" -d'{"_id":"id_monitor", "name":"monitor", "fields":["size", "resolution"], "parent_id":"id_widget"}' $base/template
